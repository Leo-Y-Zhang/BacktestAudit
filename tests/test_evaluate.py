...
from backtestaudit.evaluate import Thresholds, Verdict, evaluate
...
def test_matrix_explicit_n_trials_keeps_published_deflation() -> None:
    ...
    from backtestaudit.stats import annualized_sharpe, deflated_sharpe_ratio
...
def test_duplicated_configurations_are_not_extra_trials() -> None:
    ...
    from backtestaudit.stats import probabilistic_sharpe_ratio
...
def test_matrix_falls_back_to_published_when_cross_section_unusable() -> None:
    ...
    from backtestaudit.stats import deflated_sharpe_ratio
...
def test_single_family_matrix_collapses_to_one_effective_trial() -> None:
    ...
    from backtestaudit.stats import probabilistic_sharpe_ratio, sharpe_ratio
...
def test_matrix_short_record_falls_back_to_published_deflation() -> None:
    ...
    from backtestaudit.stats import deflated_sharpe_ratio, sharpe_ratio
