...
def expected_max_sharpe_benchmark(sigma: float, n_trials: int) -> float:
    ...
    :func:`overfitcheck.evaluate.evaluate` lets the search be measured directly
...
def cross_trial_sharpe_std(
    ...
    implementation; it is why :func:`overfitcheck.evaluate.evaluate` keeps the
...
def deflated_sharpe_ratio_from_trials(
    ...
    *effective* number of independent trials (:func:`effective_trials`), and
    ...
    selected:
        ...
        :func:`overfitcheck.evaluate.evaluate` applies to a candidate matrix).
    ...
    *,
    ...
    degenerate_value:
        ...
        .. warning::
           ...
           rather than waved through. :func:`overfitcheck.evaluate.evaluate`
           does exactly this.
